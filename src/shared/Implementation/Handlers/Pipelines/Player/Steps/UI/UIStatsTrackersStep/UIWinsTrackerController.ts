...
export class UIWinsController {
    public id = `UIWinsController`;
    ...
    public SetWins() {
        ...
        let statsCounters = mainFrame.Stats_Counters;
        let winsCounter = statsCounters.Wins_Counter;
        let amountTitle = winsCounter.Amount_Title;

        amountTitle.Text = `${AbbreviateModule.Currency(this.playerData.progression.stats.wins, 2)}`;
    }
}
